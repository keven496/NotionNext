...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'example', // 主题， 支持 ['next','hexo',"fukasawa','medium','example','nobelium'] @see https://preview.tangly1024.com
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jie Min', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'a symplectic junkie', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog, math', // 网站关键词 英文逗号隔开
